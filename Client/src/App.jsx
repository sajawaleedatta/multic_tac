...
const App = () => {
  const [gameState, setGameState] = useState(getInitialBoard);
  ...
  return (
    <div className="main-div">
            ...
            arr.map((e, colIndex) => {
              return (
                <Square
                  ...
                  key={`${gameKey}-${rowIndex * 3 + colIndex}`}
                  currentElement={e}
                />
              );
            })
      ...
      {finishedState && (
        <button onClick={handleRestart} className="playAgain">
          Play Again
        </button>
      )}
    </div>
